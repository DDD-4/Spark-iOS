...
class SwipeCardView : UIView {
    ...
    func configureImageView() {
        ...
        imageView.centerYAnchor.constraint(equalTo: swipeView.centerYAnchor).isActive = true
    ...
    func configureFlipView() {
        ...
        flipView.leftAnchor.constraint(equalTo: shadowView.leftAnchor).isActive = true
        flipView.rightAnchor.constraint(equalTo: shadowView.rightAnchor).isActive = true
        flipView.bottomAnchor.constraint(equalTo: shadowView.bottomAnchor).isActive = true
        flipView.topAnchor.constraint(equalTo: shadowView.topAnchor).isActive = true

        flipLabel.centerYAnchor.constraint(equalTo: flipView.centerYAnchor).isActive = true
        flipLabel.centerXAnchor.constraint(equalTo: flipView.centerXAnchor).isActive = true
